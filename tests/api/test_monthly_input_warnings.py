...
def test_get_state_response_includes_warnings_field() -> None:
...
@pytest.mark.skip(reason="DB-backed; enabled when CI shim is wired")
def test_get_state_response_includes_is_blocked_false() -> None:
...
@pytest.mark.skip(reason="DB-backed; enabled when CI shim is wired")
def test_get_state_response_warnings_count_matches_list() -> None:
...
@pytest.mark.skip(reason="DB-backed; enabled when CI shim is wired")
def test_get_state_response_top_n_severity_zero_when_no_warnings() -> None:
...
@pytest.mark.skip(reason="DB-backed; enabled when CI shim is wired")
def test_get_state_negative_closing_inventory_warning_surfaced() -> None:
...
@pytest.mark.skip(reason="DB-backed; enabled when CI shim is wired")
def test_get_state_overcapacity_warning_surfaced() -> None:
...
@pytest.mark.skip(reason="DB-backed; enabled when CI shim is wired")
def test_post_rows_with_warnings_field_returns_400_read_only() -> None:
...
@pytest.mark.skip(reason="DB-backed; enabled when CI shim is wired")
def test_post_rows_with_is_blocked_field_returns_400_read_only() -> None:
...
@pytest.mark.skip(reason="DB-backed; enabled when CI shim is wired")
def test_get_state_inventory_projection_failure_returns_422() -> None:
...
@pytest.mark.skip(reason="DB-backed; enabled when CI shim is wired")
def test_get_state_service_tenant_returns_zero_warnings() -> None:
