...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_single_dept_returns_dict_envelope() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_single_dept_result_hash_is_sha256_64char() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_snapshot_id_is_uuid_string() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_two_depts_aggregates_breakdown() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_three_depts_v7_balance_aggregated() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_empty_departments_raises() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_too_many_departments_raises() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_same_hash_idempotent_skip() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_idempotent_skip_writes_calc_log() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_different_hash_divergent_error() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_audit_first_insert_order() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_commit_after_snapshot() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_v8_determinism_100_iterations() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_different_trace_ids_same_hash() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_v7_verdict_block_present() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_wire_envelope_field_parity() -> None:
...
@pytest.mark.engine
@pytest.mark.asyncio
async def test_compute_and_persist_result_envelope_validates_via_pydantic() -> None:
