...
# 비즈업(Biz-Up) 통합 제품요구사항정의서(PRD) v2.3
...
| **A45** | (preserved) Epic 11 close-out retro 2nd (2026-08-20) — 11-3 honestly DEFER 3 items (T10 docs LOW + A5 partial LOW + reopen state transition LOW) still-pending. Epic 13 후속 story (13-2+) 진입 시점에 follow-up sprint 결정 (D-13-1-DEFER-3 결정 시점에 동시 결정) |
| **A46** | (preserved) Epic 11 close-out retro 2nd (2026-08-20) — 11-5 A13 residual stub UUIDs (`00000000-...`) with `TODO(11-4 carry)` markers preserved as W-class DEFER. Epic 13 후속 story (13-3+) 진입 시점에 session/RSC context resolution sweep 결정 (D-13-1-DEFER-3 결정 시점에 동시 결정) |
...
| 결정 | 내용 |
|------|------|
| **A53** | **D-13-1-DEFER-3 separate epic LISTEN/NOTIFY consume 2nd batch 결정** (cross-tenant invalidation fan-out + multi-process coordination = Epic 13 후속 story 진입 결정). 결정 wire 진입 시점: Epic 13 close-out retro 진입 후 즉시 (cj-style Epic 13 5번째 진입점). 옵션: (a) Epic 14 진입 / (b) Epic 13 follow-up sprint 진입 (cj-style Epic 13 5번째 진입점) / (c) Epic 13 close-out 후 별도 Epic 14 진입. **decision pending — A53 결정 진입 대기** |
