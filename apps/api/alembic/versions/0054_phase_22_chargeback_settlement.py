...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("target_amount_krw", sa.BigInteger, nullable=False, server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column("tenant_id", UUID(as_uuid=True), nullable=False, index=True),
        sa.Column("period_key", sa.Text, nullable=False),
        sa.Column("total_amount_krw", sa.BigInteger, nullable=False, server_default="0"),
        ...
        sa.Column("tolerance_band_krw", sa.BigInteger, nullable=False, server_default="0"),
        sa.Column("settlement_status", sa.Text, nullable=False, server_default="draft"),
    ...
    op.create_table(
        ...
        sa.Column("allocated_amount_krw", sa.BigInteger, nullable=False, server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column("tenant_id", UUID(as_uuid=True), nullable=False, index=True),
        sa.Column("period_key", sa.Text, nullable=False),
        sa.Column("allocation_amount_krw", sa.BigInteger, nullable=False, server_default="0"),
        sa.Column("invoice_amount_krw", sa.BigInteger, nullable=False, server_default="0"),
        sa.Column("ledger_amount_krw", sa.BigInteger, nullable=False, server_default="0"),
        sa.Column("variance_pct", sa.Numeric(8, 4), nullable=False, server_default="0"),
        sa.Column("variance_krw", sa.BigInteger, nullable=False, server_default="0"),
