"""cj-282a wire sprint (cj-style 283번째) — Story 30.1 CSV export schemas.

Pydantic schemas for Story 30.1 CSV export endpoint.
...
- 4 OQ N/A 마킹 (Story 30.2/30.3/30.4 wire 진입 시 결정)
- 8 NEW Literal EXTENSION 결정 wire: cj-style 284+ 적용 보류
- capability matrix v1.53 → v1.54 EXTENSION 결정 wire: cj-style 284+ 적용 보류
